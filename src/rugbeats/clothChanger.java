...
public class clothChanger extends VBox{
    ...
    public void getclothbox(ImageView img1,ImageView img2,ImageView img3){
        ...
        images.add(img2);
        images.add(img3);
        p1_hatimg =new StackPane(images.get(0));
...
//up button hold
    public void up_to_downChangeimg() {
        ...
        ImageView index0= images.get(0);
        ImageView index1= images.get(1);
        ImageView index2= images.get(2);
        images.set(0,index1);
        images.set(1,index2);
        images.set(2,index0);
        uparrow.setImage(uparrows_clicked);
        p1_hatimg.getChildren().addAll(images.get(0));
